...
| **ORM** | Sequelize |
| **Database** | MySQL |
| **Base Path** | `/inventria_new` (configurable via `BASE_PATH`) |
...
*This document is derived from the FlowBooks codebase and is intended for technical stakeholders and developers.*
