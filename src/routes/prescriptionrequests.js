...
module.exports = app => {
  ...
  app.get('/prescriptions/pending/:facilityId', prescriptionrequests.getPendingPrescriptions);
  app.get('/prescriptions/all', prescriptionrequests.getAll);
  app.get('/prescriptions/all/:patient_id/:facilityId', prescriptionrequests.getPendingRequestPharm);
  app.put('/prescriptions/update/dispense/:id/:facilityId', prescriptionrequests.updateDispense);
}